...
describe('DoctorHomeComponent', () => {
  function setup(appointments: AppointmentResponse[]) {
    ...
    return { fixture, listMyAppointmentsSpy };
  }

  it("loads the doctor's own appointments on init", () => {
    const { fixture, listMyAppointmentsSpy } = setup([appointment({ id: '1' })]);
  ...
  it('renders upcoming appointments with the patient name (feature 008)', () => {
